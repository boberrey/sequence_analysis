...
"""
Convert a directory of paired-end bam files into fasta files.
...
def main():
    ...
    bam_extension = 'bam'
    get_fasta_script = 'get_insert_fastas.sh'
    ...
    print("Running fasta script: {}".format(get_fasta_script))

    for bam_file in bam_list:
        print("Getting insert fasta for {}...".format(bam_file))
        # fasta script:
    ...
    print("Finished generating {} fasta files.".format(len(bam_list)))
